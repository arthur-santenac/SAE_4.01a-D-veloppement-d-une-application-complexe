...
function afficherFormulaireVille(ville) {
    ...
    divDroite.innerHTML = `
        ...
        <div class="form-group">
            ...
            <input type="text" id="idVille" value="${ville ? ville.idVille : ''}" disabled />
        </div>
        <div class="form-group">
    ...
    document.getElementById('btn-annuler').addEventListener('click', annulerVille);
}
...
async function sauvegarderVille() {
    ...
    try {
        if (villeActuelleId) {
            await fetch(`${API_URL_ville}/${villeActuelleId}`, {
                method: 'PUT',
